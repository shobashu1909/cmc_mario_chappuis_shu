...
class SimulationParameters:
    ...
    def __init__(self, **kwargs):
        ...
        **kwargs: optional parameters that overrides the previous parameters
        ...
        self.n_iterations  = 1001 # number of iterations (stopping time = timestep*n_iterations)
        self.equation_type = "single" # "single" for single unit, "coupled" for two coupled units
